...
def create_categories() -> dict:
    ...
    """
    return {
        "еда": ["пятерочка", "магнит", "продукты", "еда", "супермаркет", "добрянка", "мария-ра"],
        ...
        "питание в общественных местах": [ "ресторан", "кафе", "столовая", "закусочная", "кофейня"]
        ...
        "образование": ["курсы", "школа", "университет", "учебники", "онлайн-курсы", "колледж"],
