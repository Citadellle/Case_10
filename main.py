...
"скорая помощь", "медсестра", "доктор", "медосмотр", "клиника", "реабилитация",
                     "спортивная медицина", "гомеопатия"],
...
"садовая мебель", "грунт", "декор", "средства для уборки", "диспенсер", "сушилка",
                "холодильник", "освежитель воздуха", "пылесос"],
...
"линейка", "краски", "кисти", "альбом", "папка", "рюкзак", "портфель"],
...
"финансовые услуги", "перевод с пластиковой карты", "чек", "наличные"]       
    }
